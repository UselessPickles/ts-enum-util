export namespace Symbols {
     ...
     * thrown.
     */
    export const unhandledEntry = Symbol("ts-enum-util:Symbols.unhandledEntry");
     ...
     * string enum value.
     */
    export const handleNull = Symbol("ts-enum-util:Symbols.handleNull");
     ...
     * string enum value.
     */
    export const handleUndefined = Symbol(
        "ts-enum-util:Symbols.handleUndefined"
    );
     ...
     * string enum value.
     */
    export const handleUnexpected = Symbol(
        "ts-enum-util:Symbols.handleUnexpected"
    );
}
